...
#define	ObjectName			"Bitset object"
#define	ObjectAuthor		"Timon"
#define	ObjectCopyright		"Copyright © 2016"
#define	ObjectComment		"Allows bits shifting and other bits based operations, can be used for flags"
#define	ObjectURL			""
#define	ObjectHelp			"Help\\Bitset.chm"
...
#define	IDENTIFIER			MAKEID(B,I,T,S)
