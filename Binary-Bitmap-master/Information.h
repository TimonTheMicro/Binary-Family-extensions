...
#define	ObjectName			"Binary Bitmap"
#define	ObjectAuthor		"Timon"
#define	ObjectCopyright		"Copyright © 2016"
#define	ObjectComment		"Allows user to view a bitmap image or raw pixels from memory address. Supports alpha channel."
#define	ObjectURL			""
#define	ObjectHelp			"Help\\Binary Bitmap.chm"
...
#define	IDENTIFIER			MAKEID(B,I,B,M)
